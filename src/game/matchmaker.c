...
typedef int(MatchmakerGameListGet)(MatchmakerRegisterInfo**, int*);
typedef int(MatchmakerGameListFree)(MatchmakerRegisterInfo*);
...
typedef int(MatchmakerChatRoomListGet)(MatchmakerChatroom**, int*);
typedef int(MatchmakerChatRoomListFree)(MatchmakerChatroom*);
typedef int(MatchmakerChatRoomJoin)(MatchmakerChatroom*, int);
typedef int(MatchmakerChatRoomGet)(int);
typedef int(MatchmakerChatRoomMembersGet)(MatchmakerChatroomMember**, int*);
typedef int(MatchmakerChatRoomMembersFree)(MatchmakerChatroomMember*);

...
void sub_413490(int64_t a1, int64_t a2, char* a3)
{
    ...
    if (sub_4AD800(a1, a2, 0) == 0) {
        sub_413360(a1, a2, &v1);
        dialog_copy_npc_generic_msg(a3, &v1, 800, 899);
    } else {
        a3[0] = '\0';
    }
}
...
void sub_413520(int64_t a1, int64_t a2, char* a3)
{
    ...
    if (sub_4AD800(a1, a2, 0) == 0) {
        sub_413360(a1, a2, &v1);
        dialog_copy_npc_generic_msg(a3, &v1, 900, 999);
    } else {
        a3[0] = '\0';
    }
}
...
void sub_4135B0(int64_t a1, int64_t a2, char* a3)
{
    ...
    if (sub_4AD800(a1, a2, 0) == 0) {
        sub_413360(a1, a2, &v1);
        dialog_copy_npc_generic_msg(a3, &v1, 1000, 1099);
    } else {
        a3[0] = '\0';
    }
}
...
void sub_413640(int64_t a1, int64_t a2, char* a3)
{
    ...
    if (sub_4AD800(a1, a2, 0) == 0) {
        sub_413360(a1, a2, &v1);
        dialog_copy_npc_generic_msg(a3, &v1, 1100, 1199);
    } else {
        a3[0] = '\0';
    }
}
...
void sub_4136D0(int64_t a1, int64_t a2, char* a3)
{
    ...
    if (sub_4AD800(a1, a2, 0) == 0) {
        sub_413360(a1, a2, &v1);
        dialog_copy_npc_generic_msg(a3, &v1, 1200, 1299);
    } else {
        a3[0] = '\0';
    }
}
...
void sub_4137F0(int64_t a1, int64_t a2, char* a3)
{
    ...
    if (sub_4AD800(a1, a2, 0) == 0) {
        sub_413360(a1, a2, &v1);
        dialog_copy_npc_generic_msg(a3, &v1, 1300, 1399);
    } else {
        a3[0] = '\0';
    }
}
...
void sub_413880(int64_t a1, int64_t a2, char* a3)
{
    ...
    if (sub_4AD800(a1, a2, 0) == 0) {
        sub_413360(a1, a2, &v1);
        dialog_copy_npc_generic_msg(a3, &v1, 1400, 1499);
    } else {
        a3[0] = '\0';
    }
}
...
void sub_413910(int64_t a1, int64_t a2, char* a3)
{
    ...
    if (sub_4AD800(a1, a2, 0) == 0) {
        sub_413360(a1, a2, &v1);
        dialog_copy_npc_class_specific_msg(a3, &v1, 2000);
    } else {
        a3[0] = '\0';
    }
}

...
typedef bool(UI_CALLBACKS_FUNC_D4)(int a1);
...
typedef int(UI_CALLBACKS_FUNC_104)(int a1, int64_t* obj_ptr);
typedef void(UI_CALLBACKS_FUNC_108)();
typedef bool(UI_CALLBACKS_FUNC_10C)(int a1);
...
typedef bool(UI_CALLBACKS_FUNC_124)(const char* a1, int a2);

...
#define MT_ITEM_TRIG_ITEM_USED                    0x00003000u
...
#define MT_ITEM_TRIG_TARGET_ATTACKER_ANY (MT_ITEM_TRIG_TARGET_ATTACKER | MT_ITEM_TRIG_TARGET_ATTACKER_WEAPON | MT_ITEM_TRIG_TARGET_ATTACKER_ARMOR | MT_ITEM_TRIG_TARGET_ATTACKER_WEAPON_MELEE)
#define MT_ITEM_TRIG_RANDOM_CHANCE_ANY (MT_ITEM_TRIG_RANDOM_CHANCE_RARE | MT_ITEM_TRIG_RANDOM_CHANCE_UNCOMMON | MT_ITEM_TRIG_RANDOM_CHANCE_COMMON | MT_ITEM_TRIG_RANDOM_CHANCE_FREQUENT)
